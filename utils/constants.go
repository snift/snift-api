...
const (
	...
	HTTPSBadgeMessage        = "This site is encrypted and is less prone to Man-in-the-Middle attacks(MITM) and Eavesdropping Attacks"
	XSSBadge                 = "XSS_PROTECT"
	XSSBadgeMessage          = "This site is less prone to from reflected cross-site scripting (XSS) attacks"
	...
	CSPBadgeMessage          = "This site has is relatively secure against Cross Site Scripting (XSS), Data Injection and Packet Sniffing attacks"
	...
	RPBadgeMessage           = "This site has a Referrer Policy that may help protect user privacy"
	...
	SPFBadgeMessage          = "This site has a valid Sender Policy Framework(SPF) record that reduces the risk of forged emails being sent on behalf of this domain"
)
